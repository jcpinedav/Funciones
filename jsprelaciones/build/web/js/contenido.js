...
function tema2(i,j)
{
 ...
 var subtem2 = new Array (8);
    ...
    subtem2[0][0] ="<b>Introduccción</b><br><br> Factorizando  es un objeto de"+
                    " aprendizaje orientado al aprendizaje de factorización"+
                   "<br>El software básicamente contiene  tres partes: una en donde"+
                   " se presentan los conceptos de factorización,la segunda muestra un"+
                   " ejemplo trabajado y otra en donde se hace una evaluación";
    subtem2[0][1] ="<b>Objetivo</b><br><br>Formar conceptualmente acerca de la factorización"+
                       " y el desarrollo  "+
                   " <br>de conocimiento procedimental para la resolución de"+
                   "<br>problemas que involucren estos conceptos";
    subtem2[0][2] ="<b>Metodología</b><br><br>Se utiliza para el aprendizaje de conceptos "+
                   " sobre factorización, comienza dando definición del concepto; posteriormente,"+
...
subtem2[1][0] ="<b>Potencias</b><br><br>  a<sup>n</sup> = <u>a. a. a. a. . . .a</u>"+
                   " <br>&nbsp;&nbsp &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; n veces"+
...
subtem2[2][0]= "<b>Factores de un número</b><br><br>"+
                  "<br><br>Ejemplo 2.1 <br><br>Siguiendo los pasos del ejemplo expuesto en"+
                  " la izquierda, escriba a la derecha, los numeros que multiplicados den var1 ";
