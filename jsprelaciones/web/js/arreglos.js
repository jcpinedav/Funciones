...
function subMen()
{
    ...
    subMenu[1] = "<li class ='subMenu' id ='s0'>Dominio</li> ";
    ...
    subMenu[2] = "<li class ='subMenu' id ='t0'>Rango</li>";
...
function mens()
{
    //opciones del menú
         var menu ="<ul>"+
                          ...
                          "<li class ='pri' id ='m1'>Relacion - Dominio</li>"+
                          "<li class ='pri' id='m2'>Relacion - Rango</li>"+
                          "<li class ='pri' id='m3'>Relaciones y Funciones</li>"+
